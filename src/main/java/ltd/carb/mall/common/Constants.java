...
public class Constants {
    ...
    public final static int INDEX_CARS_HOT_NUMBER = 4;

    public final static int INDEX_CARS_NEW_NUMBER = 5;

    public final static int INDEX_CARS_RECOMMOND_NUMBER = 10;
    ...
    public final static String MALL_USER_SESSION_KEY = "CarBMallUser";

    public final static int CARS_SEARCH_PAGE_LIMIT = 10;
