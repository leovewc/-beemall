$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: 'Account Status', name: 'lockedFlag', index: 'lockedFlag', width: 60, formatter: lockedFormatter},
    ...
    function lockedFormatter(cellvalue) {
        if (cellvalue == 1) {
            ...
            return "<button type=\"button\" class=\"btn btn-block btn-success btn-sm\" style=\"width: 50%;\">Active</button>";
        }
    }
